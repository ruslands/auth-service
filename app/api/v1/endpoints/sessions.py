...
from app.schemas.sessions import ISessionsRead
...
@router.get("/sessions/list", response_model=IGetResponseBase[Page[ISessionsRead]])
async def read_sessions_list(
    ...
    return IGetResponseBase[Page[ISessionsRead]](data=sessions)


@router.delete("/sessions/{session_id}", response_model=IDeleteResponseBase[ISessionsRead])
async def remove_session(
    ...
    return IDeleteResponseBase[ISessionsRead](data=session)
