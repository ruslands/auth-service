...
class User(BaseUUIDModel, UserBase, table=True):
    ...
    sessions: List["Sessions"] = Relationship(back_populates="user", sa_relationship_kwargs={
                                              "cascade": "delete", 'uselist': True})
    visibility_group_id: Optional[UUID] = Field(
        default=None, foreign_key="visibility_group.id", index=True, sa_column_kwargs={"unique": False})
