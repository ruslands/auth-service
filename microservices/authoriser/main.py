...
from app.authoriser.aws.schema import (
    RequestVersion1 as AWSRequestV1,
    RequestVersion2 as AWSRequestV2,
)
from app.authoriser.service import get_access_token, rbac_validate
    ...
    async for db_session in get_session():
        ...
        if is_authorized:
            try:
                ...
                logger.debug("rbac: validation passed")
                is_authorized = True
            except Exception as e:
