...
class Test(TestCRUDBase[Team]):
    ...
    async def test_create(self, test_client):
        ...
        pytest.test_team_id = response_data["data"]["id"]
    ...
    async def test_get(self, test_client):
        _ = self._base_test_get(test_client, pytest.test_team_id)
    ...
    async def test_delete(self, test_client):
        self._base_test_delete(test_client, pytest.test_team_id)
